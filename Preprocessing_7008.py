# -*- coding: utf-8 -*-
"""WQD7003_Code - Preprocessing

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1OploZd-kofD69zYviBr0sZ4JLhWzxPIp
...
## Manipulation code
# combined_df.drop(['trans_session', 'trans_ageGroup'], axis = 1, inplace = True)
...
train_df.to_csv('temp\cleanTrain.csv')
test_df.to_csv('temp\cleanTest.csv')